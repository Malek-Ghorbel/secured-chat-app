...
def show1():
    openeye1.config(file='openeye.png')
    passwordEntry.config(show='')
...
def show2():
    ...
    confirmpasswordEntry.config(show='')
    eyeButton1.config(command=hide2)
...
signupButton = Button(frame, text='Signup', font=(
    'Open Sans', 16, 'bold'), bd=0, bg='firebrick1', fg='white', activebackground='firebrick1', activeforeground='white', width=17, command=connect_database)
signupButton.grid(row=10, column=0, pady=50)

alreadyaccount = Label(frame, text='Already have an account :', font=(
    'Open Sans', '9', 'bold'), bg='white', fg='firebrick1')
